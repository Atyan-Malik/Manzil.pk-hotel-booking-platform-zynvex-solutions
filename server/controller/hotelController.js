...
export const getAllHotelsAdmin = catchAsync(
  async (req, res) => {
...
export const reviewHotelStatus = catchAsync(
  async (req, res, next) => {
    ...
    hotel.rejectionReason =
      decision === HOTEL_STATUS.REJECTED
        ? reason || ""
        : "";
    ...
    const approved =
      decision === HOTEL_STATUS.APPROVED;
    ...
    sendEmail({
      ...
      subject: approved
        ? "Your hotel has been approved"
        : "Your hotel registration was rejected",

      html: hotelStatusTemplate(
        hotel,
        approved,
        reason
      ),
