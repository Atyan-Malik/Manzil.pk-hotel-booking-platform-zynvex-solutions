...
export const getHotelReviews = catchAsync(
  async (req, res) => {
...
export const replyToReview = catchAsync(
  async (req, res, next) => {
...
export const moderateReview = catchAsync(
  async (req, res, next) => {
    const review = await Review.findById(
      req.params.id
    );
    ...
    review.isFlagged =
      req.body.isFlagged ?? review.isFlagged;
